...
highlight Normal     term=none ctermfg=gray    cterm=none guifg=gray    gui=none guibg=none
highlight Comment    term=none ctermfg=gray    cterm=none guifg=gray    gui=none
...
highlight Type       term=bold ctermfg=red     cterm=none guifg=red gui=none
