...
-- local gui0E = "#a16a94"
-- local gui0F = "#cdab53"
local gui00 = "#0a0a0d"  -- from color0
local gui01 = "#57616C"  -- from color1
local gui02 = "#4B398B"  -- from color2
local gui03 = "#6F7787"  -- from color3
local gui04 = "#827C8F"  -- from color4
local gui05 = "#7A8591"  -- from color5
local gui06 = "#9497A6"  -- from color6
local gui07 = "#d4d3da"  -- from color7
local gui08 = "#949398"  -- from color8
local gui09 = "#57616C"  -- from color9
local gui0A = "#4B398B"  -- from color10
local gui0B = "#6F7787"  -- from color11
local gui0C = "#827C8F"  -- from color12
local gui0D = "#7A8591"  -- from color13
local gui0E = "#9497A6"  -- from color14
local gui0F = "#d4d3da"  -- from color15
